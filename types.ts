...
//Unknown Type
//you can store any value in unknown without getting errors on compilation (like any-type) 
...
function generateError(message: string, code: number): never {
    throw {message: message,
            errorCode: code}
            //throw here prevents a return value from being registered like it normally would in js even if there was no explicit return ('undefined')
}
//if you set the return type to never, it is clear that the function is not supposed to return anything
